    ...
    >
      ...
      colors={['#BD0DF4', '#FA3EBA']}style={styles.contentContainer}>
          ...
          <View style={[styles.inputContainer,{marginTop:30}]}>
           ...
           <Text style={{fontWeight:'600',fontSize:14,color:'#BD0DF4'}}>OPERATION TRUE LOVE</Text>
          </View>
          <View style={[styles.inputContainer,{}]}>
           
           <Text style={{fontWeight:'600',fontSize:14,color:'#BD0DF4'}}>FLIRT ON DEMAND</Text>
          </View>
          <View style={[styles.inputContainer,{}]}>
           
           <Text style={{fontWeight:'600',fontSize:14,color:'#BD0DF4'}}>FRIENDS FIRST</Text>
          </View>
      
          <TouchableOpacity
          onPress={()=>{
            navigation.navigate(ScreenNameEnum.ASK_FINAL)
