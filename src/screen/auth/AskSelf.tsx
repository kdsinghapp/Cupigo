    ...
    >
        <View style={styles.logoContainer}>
          ...
          <View  
            ...
            >
              <View  style={{backgroundColor:'#794ebc',height:20,width:'30%',borderRadius:20}} />
      ...
      colors={['#BD0DF4', '#FA3EBA']}style={styles.contentContainer}>
          ...
          <View style={styles.inputContainer}>
           <Image  source={image.Gender} style={{height:30,width:30}} /> 
            <TextInput
          ...
          <TouchableOpacity
          onPress={()=>{
            navigation.navigate(ScreenNameEnum.ASK_LIVE)
